                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('img/demo/authors/<?php if(empty($user['image'])) echo 'josh.png'; else echo $user['image'];?>'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a href="page_profile.php?id=<?=$user['user_id']?>" class="fs-xl text-truncate text-truncate-lg text-info"><?=$user['name']?></a>
                                    <?php
                                        if ($auth->hasRole(\Delight\Auth\Role::ADMIN) || $auth->getEmail() == $user['email']):
                                    ?>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="/status/<?=$user['user_id']?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="/medias/<?=$user['user_id']?>">
                                            <i class="fa fa-camera"></i>
                                            Загрузить аватар
                                        </a>
                                        <a href="/user_delete/<?=$user['user_id']?>" class="dropdown-item" onclick="return confirm('are you sure?');">
